...
@interface JSWeiboPictureMetadata : NSObject
...
@protocol JSWeiboPicture
@end
@interface JSWeiboPicture : NSObject
@property (nonatomic, strong) NSString *picID;
@property (nonatomic, strong) NSString *objectID;
@property (nonatomic, assign) int photoTag;
@property (nonatomic, assign) BOOL keepSize;
@property (nonatomic, strong) JSWeiboPictureMetadata *thumbnail;
@property (nonatomic, strong) JSWeiboPictureMetadata *bmiddle;
@property (nonatomic, strong) JSWeiboPictureMetadata *middlePlus;
@property (nonatomic, strong) JSWeiboPictureMetadata *large;
@property (nonatomic, strong) JSWeiboPictureMetadata *largest;
@property (nonatomic, strong) JSWeiboPictureMetadata *original;
@end

@protocol JSWeiboURL
@end
@interface JSWeiboURL : NSObject
...
@interface JSWeiboUser : NSObject
...
@interface JSWeiboStatus : NSObject
@property (nonatomic, assign) uint64_t statusID;
@property (nonatomic, strong) NSString *idstr;
@property (nonatomic, strong) NSString *mid;
@property (nonatomic, strong) NSString *rid;
@property (nonatomic, strong) NSDate *createdAt;
@property (nonatomic, strong) JSWeiboUser *user;
@property (nonatomic, assign) int32_t userType;
@property (nonatomic, strong) NSString *text;
@property (nonatomic, strong) NSArray *picIds;        /// Array<NSString>
@property (nonatomic, strong) NSDictionary<JSWeiboPicture> *picInfos; /// Dic<NSString, JSWeiboPicture>
@property (nonatomic, strong) NSArray<JSWeiboURL> *urlStruct;     ///< Array<JSWeiboURL>
