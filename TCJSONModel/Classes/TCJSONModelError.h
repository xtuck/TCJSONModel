...
/////////////////////////////////////////////////////////////////////////////////////////////
typedef NS_ENUM(int, kTCJSONModelErrorTypes)
{
    kTCJSONModelErrorInvalidData = 1,
    kTCJSONModelErrorBadResponse = 2,
    kTCJSONModelErrorBadJSON = 3,
    kTCJSONModelErrorModelIsInvalid = 4,
    kTCJSONModelErrorNilInput = 5
};

/////////////////////////////////////////////////////////////////////////////////////////////
/** The domain name used for the JSONModelError instances */
extern NSString *const TCJSONModelErrorDomain;
 ...
 */
extern NSString *const kTCJSONModelMissingKeys;
 ...
 */
extern NSString *const kTCJSONModelTypeMismatch;
 ...
 */
extern NSString *const kTCJSONModelKeyPath;
 ...
 */
@interface TCJSONModelError : NSError

/**
 * Creates a JSONModelError instance with code kTCJSONModelErrorInvalidData = 1
 */
...
/**
 * Creates a JSONModelError instance with code kTCJSONModelErrorBadResponse = 2
 */
+ (id)errorBadResponse;

/**
 * Creates a JSONModelError instance with code kTCJSONModelErrorBadJSON = 3
 */
+ (id)errorBadJSON;

/**
 * Creates a JSONModelError instance with code kTCJSONModelErrorModelIsInvalid = 4
 */
+ (id)errorModelIsInvalid;

/**
 * Creates a JSONModelError instance with code kTCJSONModelErrorNilInput = 5
 */
+ (id)errorInputIsNil;
