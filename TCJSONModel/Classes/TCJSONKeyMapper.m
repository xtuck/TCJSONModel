...
@implementation TCJSONKeyMapper

- (instancetype)initWithJSONToModelBlock:(TCJSONModelKeyMapBlock)toModel modelToJSONBlock:(TCJSONModelKeyMapBlock)toJSON
{
    return [self initWithModelToJSONBlock:toJSON];
}

- (instancetype)initWithModelToJSONBlock:(TCJSONModelKeyMapBlock)toJSON
{
    if (!(self = [self init]))
        return nil;
...
{
    NSDictionary *toJSON  = [TCJSONKeyMapper swapKeysAndValuesInDictionary:map];
...
- (TCJSONModelKeyMapBlock)JSONToModelKeyBlock
{
    return nil;
}
...
+ (instancetype)mapper:(TCJSONKeyMapper *)baseKeyMapper withExceptions:(NSDictionary *)exceptions
{
    NSDictionary *toJSON = [TCJSONKeyMapper swapKeysAndValuesInDictionary:exceptions];
